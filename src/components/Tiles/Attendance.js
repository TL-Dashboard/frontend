            ...
            <form className="tile__attendance">
                <div className="tile__attendance__container">
                    <div className="tile__attendance__container__smallcontainer">
                            <label htmlFor="tile__attendance__container__smallcontainer--item">Date </label>
                    ...
                    <div className="tile__attendance__container__smallcontainer">
                            <label htmlFor="tile__attendance__container__smallcontainer--item">Module </label>
                    ...
                    <div className="tile__attendance__container__smallcontainer">
                            <label htmlFor="tile__attendance__container__smallcontainer--item">Start of Class</label>
                            <input type='checkbox' className="tile__attendance__container__smallcontainer--item" name="startClass" defaultChecked />
                            <br/>
                            <label htmlFor="tile__attendance__container__smallcontainer--item">Stand Up</label>
                            <input type='checkbox' className="tile__attendance__container__smallcontainer--item" name="standUp" defaultChecked />
                    </div>
                    <div className="tile__attendance__container__smallcontainer">
                            <label htmlFor="tile__attendance__container__smallcontainer--item">Student </label>
                        ...
                        <label htmlFor="tile__attendance__container__smallcontainer--item">Present</label>
