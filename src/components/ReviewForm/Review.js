...
return (
    ...
    <label htmlFor="review__container__smallcontainer--item">Grade </label>
        <select className="review__container__smallcontainer--item" name="date">
            <option value='great'><span role="img" aria-pressed="grinning-face">😀</span> I'm feeling great</option>
            <option value='okay'><span role="img" aria-pressed="neutral-face">😐</span> I'm feeling okay</option>
            <option value="hard"><span role="img" aria-pressed="slightly-frowning-face">🙁</span> Okay, this is hard</option>
            <option value='discouraged'><span role="img" aria-pressed="pouting-face">😡</span> I'm feeling discouraged</option>
        </select>
    </div>
